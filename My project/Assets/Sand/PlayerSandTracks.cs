...
public class PlayerSandTracks : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        sandMat = sandTerrain.GetComponent<MeshRenderer>().material;
        sandMat.SetTexture("_Splat", splatmap = new RenderTexture(1024, 1024, 0, RenderTextureFormat.ARGBFloat));
    }
